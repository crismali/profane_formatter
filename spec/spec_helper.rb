# these lines are commented out since we're not using spork and copy and pasted this from rspec
# these lines are commented out since we're not using spork and copy and pasted this from rspec
# these lines are commented out since we're not using spork and copy and pasted this from rspec
# these lines are commented out since we're not using spork and copy and pasted this from rspec
# these lines are commented out since we're not using spork and copy and pasted this from rspec
...
Object.new.tap do |object| # tapping just to get the blocks levels right
...
require_relative "../lib/profane_formatter"
